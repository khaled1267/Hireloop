...
export default function CompanyProfile({ recruiter, recruiterCompany }) {
  ...
  // ২. Client side Imgbb Upload Handler
  ...
  const handleSubmit = async (e) => {
    ...
    const newCompanyData = {
      _id: company?._id || undefined, // আগের আইডি থাকলে তা ধরে রাখবে (আপডেটের জন্য জরুরি)
      name: companyName,
      websiteUrl,
    ...
    try {
      // ব্যাকএন্ড অ্যাকশন কল করা হচ্ছে
      const payload = await createCompany(newCompanyData);

      // ডাটাবেজে সফলভাবে সেভ হলে কন্ডিশন চেক (আপনার API রেসপন্স অনুযায়ী payload চেক করুন)
      if (payload) {
        setCompany({
          ...newCompanyData,
          _id: company?._id || payload.insertedId // যদি নতুন তৈরি হয় তবে নতুন আইডি বসবে
        });
  ...
  // ৪. State Toggle helper triggers
      ...
      <div className="max-w-4xl mx-auto my-8 bg-zinc-950 border border-zinc-900 rounded-xl p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-zinc-900/30 border border-zinc-900 p-4 rounded-lg">
            ...
            <span className="text-zinc-300 font-medium mt-1 block">
              {company.employeeCount} {company.employeeCount?.includes('employee') ? '' : 'employees'}
            </span>
          </div>
        </div>
        ...
        <Fieldset className="space-y-6 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              {/* FIXED: name এবং defaultValue সরাসরি Input-এ দেওয়া হয়েছে */}
              <Input 
                name="companyName"
            ...
            <Select
              ...
              name="industry"
              defaultSelectedKeys={[company?.industry?.toLowerCase() || "technology"]}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="relative flex items-center">
                ...
                {/* FIXED: name এবং defaultValue সরাসরি Input-এ স্থানান্তরিত */}
                <Input
                  name="websiteUrl"
          ...
          <TextField className="flex flex-col gap-1 w-full">
            ...
            {/* FIXED: name এবং defaultValue সরাসরি TextArea-তে স্থানান্তরিত */}
            <TextArea
              name="description"
