...
export default function JobFilters({ 
  searchQuery = "", // ডিফল্ট মান ফিক্স করা হলো
  setSearchQuery, 
  selectedType = "all", // ডিফল্ট মান ফিক্স করা হলো
  setSelectedType, 
  selectedCategory = "all", // ডিফল্ট মান ফিক্স করা হলো
  setSelectedCategory,
  isRemoteOnly = false, // ডিফল্ট মান ফিক্স করা হলো
  setIsRemoteOnly
}) {
  return (
    <div className="flex flex-col gap-4 bg-zinc-900/50 p-6 rounded-[24px] border border-zinc-800/80 max-w-7xl mx-auto mb-10">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
        ...
        <div className="md:col-span-3">
          ...
          >
            <Select.Trigger className="w-full flex items-center justify-between bg-zinc-800 text-white border border-zinc-700 hover:border-zinc-600 rounded-xl py-2.5 px-4 text-sm font-normal transition-all">
              {/* Optional chaining (?.) যোগ করা হয়েছে যাতে undefined হলেও replace ক্র্যাশ না করে */}
              <Select.Value>
            ...
            <Select.Popover className="bg-zinc-800 border border-zinc-700 rounded-xl shadow-xl mt-1 overflow-hidden z-50">
              <ListBox className="p-1">
                ...
                <ListBox.Item id="remote" className="flex items-center justify-between text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize">
                  <span>remote</span>
                </ListBox.Item>
              </ListBox>
            </Select.Popover>
        ...
        <div className="md:col-span-3">
          ...
          >
            <Select.Trigger className="w-full flex items-center justify-between bg-zinc-800 text-white border border-zinc-700 hover:border-zinc-600 rounded-xl py-2.5 px-4 text-sm font-normal transition-all">
              {/* ক্যাটাগরি আনডিফাইন্ড বা খালি থাকলে "All Categories" দেখাবে */}
              <Select.Value>
